...
/**
* Cursor BrushTip Outline Stroke Width (Thickness) option  being used;
* (Simple, read-only).  0 = Thin, 1 = Normal,  2 = Bold, 3 = Extra Bold
*/
#define propPaintBrushTipOutlineStrokeWidth	'PCrT'
...
/** This property will return the feature access level of photoshop (Simple, read-only)
 ...
 *  5:     off
*/
#define propFeatureAccessLevel  'acLv'
...
* \deprecated - Use propScratchVolumePath below
*/
...
/**
* Return a boolean indicating whether or not content authenticity is available for the
* current user.
*/
#define propCAIAvailable	'CaiA'

/**
* GPUFlags (Simple, read-only)
* bits are 00ns,anbp,egc0,00mm
* n=Native GPU is enabled
* s=Native GPU support is available
...
// --------------------------------------------
// We have removed GPUMode from preferences, however there might still be plugins
// depending on the values passed in via flags, so these values have been left in
// place.
...
// Feb 2022
// With the (impending as of Feb 2022) removal of OpenGL, the distinction between OpenGL
// and native GPU made by these flags is irrelevant. We are not removing any of the flags
// because that would break the plugin interface.

// These two flags are equivalent:
//   kGPUFlagsGPUPossible
//   kGPUFlagsNativeGPUPossible

// These two flags are equivalent:
//   kGPUFlagsGPUEnabled
//   kGPUFlagsNativeGPUEnabled

#define kGPUFlagsGPUEnabled			0x0080	// "Use graphics processor" checkbox is checked
#define kGPUFlagsGPUPossible		0x0100	// OpenGL GPU is capable of being used in Photoshop
#define kGPUFlagsCLCompute			0x0020
#define kGPUFlagsNativeGPUPossible  0x1000  // Native GPU is capable of being used in Photoshop
#define kGPUFlagsNativeGPUEnabled   0x2000  // "Use graphics processor" checkbox is checked
...
/**
* Use this to determine if document is a cloud document. (Simple, read-only).
*/
