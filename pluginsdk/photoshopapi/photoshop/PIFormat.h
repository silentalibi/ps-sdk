...
/** Plug-in prefers to open and close files itself. The host should not open file.
* This property key reflects the \c SupportsPluginOpeningFile property in the PiPL resource file.
* See \c hostSupportsPluginOpeningFile
*/
...
#define formatNeedsExternalCodecs  -30506 /** < External Codecs need to be installed to support Heic image import. */
/** @} */
//@}
...
typedef struct FormatRecord
    ...
    Boolean      hostSupportsPluginOpeningFile;         /**< Indicates whether the host is letting the plug-in open and close
                                                             the file for itself.  The dataFork, rsrcFork, and posixFileDescriptor
                                                             fields are undefined. */

    Boolean      hostSupportsSingleOpenToBulkSwitch;    /**< Set by host to true before a formatSelectorReadStart call
                                                             to let plug-in know the pluginWantsSingleOpenToBulkSwitch field
                                                             is supported. */
		
    Boolean      pluginWantsSingleOpenToBulkSwitch;     /**< Set by plug-in during a formatSelectorReadStart call
                                                             telling the host to process the results as if the host
                                                             had called formatSelectorBulkSettings instead. */
