...
typedef struct {
    /** Perform a liveobject action
    */
    ASAPI ASErr    (*PerformAction) (ScriptValueRef args, ScriptValueRef* result, SPBoolean* isError);
