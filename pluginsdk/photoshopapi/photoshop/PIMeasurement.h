...
typedef struct MeasurementExportRecord
	...
	SPPlatformFileSpecificationW	dataDirectory;			/* Directory to store files related to export
                                                               Deprecated - Use dataDirectoryX below. */
    ...
    // Members - General - Cross Platform-Friendly
    int16                   hostSupportsXPlatSpec;          /* Indicates whether the host supports cross-platform-friendly
                                                               file specification API. */
    XPlatFileSpec           *dataDirectoryX;                /* Directory to store files related to export
                                                               Unicode, cross-platform-friendly file specification.*/
        
	char					reserved[246];					/* Reserved.  Set to zero. */
	}
