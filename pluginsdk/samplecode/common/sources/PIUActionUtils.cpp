	...
	while (counter < listCount)
	{
		...
		switch (typeID)
		{
			...
			case typeAlias:
				{
				// Get some local data
				Handle aliasValue = (Handle)'utxt'; // this tells Photoshop to give a UTF16 on windows
				...
				// Get the information out of the Handle via the Host
				// This will return a UTF8 string
