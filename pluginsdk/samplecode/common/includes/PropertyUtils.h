...
enum AccessLevel { alundefined = 0, alrelease, alpublicBeta, alpreRelease, alinternal, aloff };
...
OSErr PIGetCloudDocument(bool & inCloud);
OSErr PIGetAccessLevel(AccessLevel & accessLevel);
