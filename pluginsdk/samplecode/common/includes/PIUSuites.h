...
extern AutoSuite<PSBasicActionControlProcsOld> sPSBasicActionControlOld;
extern AutoSuite<PSActionReferenceProcs> sPSActionReference;
extern AutoSuite<PSActionReferenceProcsOld> sPSActionReferenceOld;
...
extern AutoSuite<PsUXPSuite1> sUXP;
...
public:
	...
	void Unload(void)
	{
		...
		{
			sSPBasic->ReleaseSuite(suiteName, (int32)suiteVersion);
			suite = NULL;
		}
	}
